...
A quantum state of a system is represented by a column vector, similar to a probabilistic state. Vectors representing quantum states are characterized by the following properties.
\begin{enumerate}
  \item The entries of a quantum state vector are complex numbers.
  \item The sum of the absolute value squared of the entries of a quantum state vector is 1.
\end{enumerate}
